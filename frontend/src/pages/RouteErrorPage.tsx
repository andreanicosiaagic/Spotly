...
export default function RouteErrorPage() {
  ...
  return <div className="spotly-card p-8 text-center">
    <p className="m-0 text-[11px] font-extrabold uppercase tracking-[.08em] text-[var(--c-a89e92)]">Spotly</p>
    <h1 className="mt-2 mb-2 text-2xl font-bold text-text">{title}</h1>
    <p className="mb-5 text-sm text-text-muted">{detail}</p>
    <Link to="/" className="inline-flex rounded-[14px] bg-[var(--c-2b2622)] px-5 py-3 text-sm font-bold text-white no-underline">Torna alla dashboard</Link>
  </div>
}
