...
const iconMap: Record<string, ReactNode> = {
  ...
  directions_car: <>
    ...
    <circle cx="8" cy="15.5" r="1.5" fill="var(--c-fbf6ef)" />
    <circle cx="16" cy="15.5" r="1.5" fill="var(--c-fbf6ef)" />
  </>,
  ...
  error: <>
    ...
    <path d="M12 7v6" fill="none" stroke="var(--c-fbf6ef)" strokeLinecap="round" strokeWidth="2.2" />
    <circle cx="12" cy="16.5" r="1.2" fill="var(--c-fbf6ef)" />
  </>,
  groups: <>
  ...
  info: <>
    <circle cx="12" cy="12" r="9" fill="currentColor" />
    <path d="M12 11v5" stroke="var(--c-fbf6ef)" strokeWidth="2.1" strokeLinecap="round" />
    <circle cx="12" cy="8" r="1.2" fill="var(--c-fbf6ef)" />
  </>,
  desktop_windows: <>
  ...
  check_circle: <>
    <circle cx="12" cy="12" r="9" fill="currentColor" />
    <path d="m8.2 12.2 2.4 2.4 5.2-5.2" fill="none" stroke="var(--c-fbf6ef)" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" />
  </>,
  redeem: <>
    ...
    <path d="M12 8.5v11.5" stroke="var(--c-fbf6ef)" strokeWidth="1.8" />
  </>,
  lunch_dining: <>
